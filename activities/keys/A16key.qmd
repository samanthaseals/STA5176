...
observed_table <- matrix(c(9, 29, 34, 12,
                           41, 39, 46, 38), 
...
- $H_0: \ $ promotion does not depend on age
- $H_1: \ $ promotion depends on age
...
- Reject $H_0$ at the $\alpha=0.05$ level. There is sufficient evidence to suggest that promotion depends on age.
...
- Fail to reject $H_0$ at the $\alpha=0.05$ level. There is not sufficient evidence to suggest that promotion depends on age.
...
- $H_0: \ \pi_{\text{warranty}} = \pi_{\text{no warranty}}$ 
- $H_1: \ \pi_{\text{warranty}} \ne \pi_{\text{no warranty}}$ 
...
- Fail to reject $H_0$ at the $\alpha=0.05$ level. There is not sufficient evidence to suggest offering the warranty changes the proportion who will purchase a mower.