...
-   Recall the sheep data from Lecture 3. An experiment was conducted to evaluate the effectiveness of a treatment for tapeworm in the stomachs of sheep. A random sample of 24 worm-infested lambs was randomly divided into two groups: treatment and control. Let's now use the appropriate hypothesis test to determine if the treatment decreased the worm count in sheep. Test at the $\alpha=0.01$ level.

```{r, echo = TRUE}
worms <- c(18, 13, 43, 35, 28, 38, 50, 33, 16,  6, 32,  7,
           40, 39, 54, 23, 26, 48, 63, 58, 21, 28, 37, 39)
